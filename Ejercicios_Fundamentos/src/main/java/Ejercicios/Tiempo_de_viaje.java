 ...
 * los tres tramos de viaje en minutos. Desarrolle un programa que devuelva el
...
public class Tiempo_de_viaje {
	public static void main(String[] args) {
		try (Scanner entrada = new Scanner(System.in)) {
			...
			tramo1 = entrada.nextInt();
			System.out.println("Segundo tramo:");
			tramo2 = entrada.nextInt();
			System.out.println("Tercer tramo:");
			tramo3 = entrada.nextInt();
			...
			System.out.println("\nSeñor@ " + name + " el tiempo total transcurrido en su viaje fue de: " + horas
					+ " horas con " + minutos + " minutos");
		} catch (Exception e) {
